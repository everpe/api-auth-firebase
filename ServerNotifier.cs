...
{
    private static readonly TimeSpan Periodo = TimeSpan.FromSeconds(1000000);
             ...
             await timer.WaitForNextTickAsync(stoppingToken))
        {
            ...
            if (usuario is not null)
            {
                ...
                await _contextSR.Clients.User(usuario.FirebaseId!)
                        .RecibeNotification($@"Producto del dia para comprar: {producto.Nombre} 
                        - Paga Solo {producto.Precio}");
